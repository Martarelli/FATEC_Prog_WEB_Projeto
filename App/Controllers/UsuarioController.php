...
class UsuarioController extends Controller
{
    ...
    public function exclusao($params)
    {
        ...
        if(!$usuario){
            Sessao::gravaMensagem("Usuario (idUsuario:{$id}) inexistente.");
            $this->redirect('/usuario');
        }
    ...
    public function excluir()
    {
        ...
        try {
            ...
            if(!$usuarioDAO->excluir($usuario->getIdUsuario())){
                Sessao::gravaMensagem("Usuario (idUsuario:{$usuario->getIdUsuario()}) inexistente.");
                $this->redirect('/usuario');
            }
    ...
    public function resetPassword()
    {
        ...
        if ($erros) {
            Sessao::gravaErro($erros);
            $this->redirect('/login/reset' . $usuario->getIdUsuario());
        }
